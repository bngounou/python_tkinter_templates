...
class ScrollbarListBox(Tk):
    def __init__(self):
        ...
        self.mylstbox.pack(side="left", fill=BOTH)  # listbox add  scrollbar to the window left side
...
if __name__ == '__main__':
    myroot = ScrollbarListBox()  # creating an instance of Scrollbar_Listbox
